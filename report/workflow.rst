Variants were called following the `GATK best practices workflow`_:
Reads were mapped onto {{ snakemake.config["refname"] }} build with `BWA mem`_, and both optical and PCR duplicates were removed with Picard_.
